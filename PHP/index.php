...
$error = null;
	...
	if($_POST["submit"]){
		...
		if($error){
			...
			if(mail("autumn.beauty818@gmail.com", "Comment from website!", "Name: ".$_POST['name']."
				Email:".$_POST['email']."
			...
			$result = '<div class="alert alert-danger">Sorry, there was an error sendin your message. Please try again later.</div>';
